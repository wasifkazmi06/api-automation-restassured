...
public class NACHpresentmentTestCashLoan {
    ...
    @Description("NACH presentment for CASH_LOAN product")
    @Feature("CASH_LOANRazorPayPresentment")
    @Test(priority = 1,groups = { "NACHPresentment", "sanity", "E2E"})
    public void cashLoanCollectionInitiate() throws Exception {
        ...
        queryParamDetailsGetUserPlatform.put("mobile", NACHPresentmentData.razorpayNBUser_CL_SUCCESS);

        userData = getUserData.get(queryParamDetailsGetUserPlatform, headerDetailsGetUserPlatform);
        um_uuid = userData.getUmUuid();

        InitiateCollectionRequestStep.initiateCollection(NACHPresentmentData.amount, NACHPresentmentData.cash_loanProduct,um_uuid,"");
    ...
    public void cashLoanCollectionSuccessWebhook() throws Exception {
    ...
    public void verifyCollectionSuccess() throws Exception {
        ...
        Assert.assertTrue(collectionDetails.get("state").equals("SENT_TO_SOURCE"), "Check that sent to LP cron ran successfully");
    ...
    public void cashLoanCollectionFailedInitiate() throws Exception {
        Map<String, Object> queryParamDetailsGetUserPlatform = new HashMap<>();
        HashMap<String, String> headerDetailsGetUserPlatform = new HashMap<>();
    ...
    public void cashLoanCollectionFailedWebhook() throws Exception {
        Response response;
    ...
    public void verifyCollectionFailed() throws Exception {
        ...
        getCollectionDetail(um_uuid);
        Allure.addAttachment("Actual amount : " + collectionDetails.get("amount") , " Expected amount : " + amount);
        Allure.addAttachment("Actual state : " + collectionDetails.get("state") , " Expected state : " + "SENT_TO_SOURCE");
