...
public class EligibilityV4Tests {

    public static String signature;

    public static EligibilityPojo eligibilityPojo;

    @Description("To verify the eligibility of a valid user using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 1,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityForEligibleUserV4() throws Exception {
        ...
        request.put("version", TransactionData.ELIGIBILITY_V4);
    ...
    @Description("To verify the eligibility for user with no mobile in eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 2,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4NoMobile() throws Exception {
    ...
    @Description("To verify the eligibility for user with invalid mobile in eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 3,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4InvalidMobile() throws Exception {
    ...
    @Description("To verify the eligibility for user with invalid mobile format in eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 4,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4ForInvalidMobileFormat() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without email using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 5,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4ForEligibleUserWithoutEmail() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without firstname using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 6,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4ForUserWithoutFirstName() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without last name using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 7,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4ForUserWithoutLastName() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without product details using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 8,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4WithoutProductDetails() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without address details using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 9,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4WithoutAddressDetails() throws Exception {
    ...
    @Description("To verify the eligibility of a  user with invalid amount using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 10,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4WithInvalidAmount() throws Exception {
    ...
    @Description("To verify the eligibility of a  user with invalid currency using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 11,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4WithInvalidCurrency() throws Exception {
    ...
    @Description("To verify the eligibility of a blocked user using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 12,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4UserBlocked() throws Exception {
    ...
    @Description("To verify the eligibility of a fraud blocked using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 13,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4UserFraud() throws Exception {
        ...
        Assert.assertEquals(CheckEligibility.eligibilityPojo.message,"Oops!! Your LazyPay account seems to be suspended", "Failure reason could be different else check if the validation still exist in code");
    ...
    @Description("To verify the eligibility of locked user using eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 14,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4UserLocked() throws Exception {
        ...
        Assert.assertEquals(CheckEligibility.eligibilityPojo.message,"Oops!! Your account seems to be locked", "Failure reason could be different else check if the validation still exist in code");
    ...
    @Description("To verify the  eligibility V4 API without signature")
    @Feature("EligibilityV4")
    @Test(priority = 15,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4WithoutSignature() throws Exception {
    ...
    @Description("To verify the eligibility V4 for signature mismatch")
    @Feature("EligibilityV4")
    @Test(priority = 16,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4SignatureMismatch() throws Exception {
    ...
    @Description("To verify the eligibility V4 for invalid merchant")
    @Feature("EligibilityV4")
    @Test(priority = 17,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4InvalidMerchant() throws Exception {
    ...
    @Description("To verify the eligibility V4 for maximum transaction limit")
    @Feature("EligibilityV4")
    @Test(priority = 18,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4MaxTxnLimit() throws Exception {
    ...
    @Description("To verify the eligibility V4 for amount > credit limit")
    @Feature("EligibilityV4")
    @Test(priority = 19,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4TxnAmtGTLimit() throws Exception {
    ...
    @Description("To verify the eligibility V4 for txn amount > balance amount")
    @Feature("EligibilityV4")
    @Test(priority = 20,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4TxnGTBalance() throws Exception {
    ...
    @Description("To verify the eligibility V4 for more than 10 custom params")
    @Feature("EligibilityV4")
    @Test(priority = 21,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV4CustomParamLimit() throws Exception {
    ...
    @Description("To verify the eligibility V4 for fraud domain, new user")
    @Feature("EligibilityV4")
    @Test(priority = 22,groups = { "eligibility","transaction", "regression"})
    public void verifyFraudDomainV4() throws Exception {
    ...
    public void verifyCustomParamKeyLimitV4() throws Exception {
    ...
    @Description("To verify the eligibility V4 without custom params")
    @Feature("EligibilityV4")
    @Test(priority = 24,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4WithoutCustomParams() throws Exception {
    ...
    @Description("To verify the eligibility for non transacted user with valid details in eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 25,groups = { "eligibility","transaction","regression"})
    public void verifyEligibilityForEligibleNonTransactedUserV4() throws Exception {
    ...
    @Description("To verify the eligibility for new user with valid details in eligibility V4 API")
    @Feature("EligibilityV4")
    @Test(priority = 26,groups = { "eligibility","transaction","regression"})
    public void verifyEligibilityForEligibleNewUserV4() throws Exception {
    ...
    @Description("To verify the eligibility V4 is allowed for an amount less than maximum transaction limit")
    @Feature("EligibilityV4")
    @Test(priority = 27,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4LessThanMaxTxnLimit() throws Exception {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V4 API with source=CITRUS_SDK")
    @Feature("EligibilityV4")
    @Test(priority = 28,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4SourceCitrusSDK() {
    ...
    @Description("To verify the data type in eligibility V4 response when source=CitrusSDK")
    @Feature("EligibilityV4")
    @Test(priority = 29,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4DataTypeValidationSourceCitrusSDK() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V4 API with source=CITRUS_SSLV4")
    @Feature("EligibilityV4")
    @Test(priority = 30,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4SourceCitrusSSLV4() throws Exception {
    ...
    @Description("To verify the data type in eligibility V4 response when source=CitrusSSLV4")
    @Feature("EligibilityV4")
    @Test(priority = 31,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4DataTypeValidationSourceCitrusSSLV4() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V4 API with source=STANDALONE_API")
    @Feature("EligibilityV4")
    @Test(priority = 32,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4SourceStandaloneAPI() throws Exception {
    ...
    @Description("To verify the data type in eligibility V4 response when source=STANDALONE_API")
    @Feature("EligibilityV4")
    @Test(priority = 33,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4DataTypeValidationSourceStandaloneAPI() {
        ...
        Assert.assertEquals(CheckEligibility.eligibilityPojo.eligibilityResponseId.getClass().getSimpleName(), String.class.getSimpleName());
        Assert.assertEquals(CheckEligibility.eligibilityPojo.customParams.getClass().getSimpleName(), LinkedHashMap.class.getSimpleName());
        Assert.assertEquals(CheckEligibility.eligibilityPojo.billedAmount.getClass().getSimpleName(), Double.class.getSimpleName());
        Assert.assertEquals(CheckEligibility.eligibilityPojo.convenienceFee.getClass().getSimpleName(), Double.class.getSimpleName());
        //Assert.assertEquals(CheckEligibility.eligibilityPojo.signUpModes.getClass().getSimpleName(), ArrayList.class.getSimpleName());
        Assert.assertEquals(CheckEligibility.eligibilityPojo.emailRequired.getClass().getSimpleName(), Boolean.class.getSimpleName());
        ...
        Allure.addAttachment(CheckEligibility.eligibilityPojo.eligibilityResponseId.getClass().getSimpleName(), String.class.getSimpleName());
        Allure.addAttachment(CheckEligibility.eligibilityPojo.customParams.getClass().getSimpleName(), LinkedHashMap.class.getSimpleName());
        Allure.addAttachment(CheckEligibility.eligibilityPojo.billedAmount.getClass().getSimpleName(), Double.class.getSimpleName());
        Allure.addAttachment(CheckEligibility.eligibilityPojo.convenienceFee.getClass().getSimpleName(), Double.class.getSimpleName());
        //Allure.addAttachment(CheckEligibility.eligibilityPojo.signUpModes.getClass().getSimpleName(), ArrayList.class.getSimpleName());
        Allure.addAttachment(CheckEligibility.eligibilityPojo.emailRequired.getClass().getSimpleName(), Boolean.class.getSimpleName());
    }
    @Description("To verify the eligibility of a valid user using eligibility V4 API with source=STANDALONE_REDIRECT")
    @Feature("EligibilityV4")
    @Test(priority = 34,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4SourceCitrusStandaloneRedirect() throws Exception {
    ...
    @Description("To verify the data type in eligibility V4 response when source=STANDALONE_REDIRECT")
    @Feature("EligibilityV4")
    @Test(priority = 35,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV4DataTypeValidationSourceStandaloneRedirect() {
    ...
    @Description("To verify the 2FA enable=true for 2FA and deviceRule enabled merchant using eligibility V4 API when txnAmount>maxTxnAmount set in fraud")
    @Feature("EligibilityV4")
    @Test(priority = 36, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMaxTxnAmtEligibilityV4() throws Exception {
    ...
    @Description("To verify the 2FA enable=false for 2FA and deviceRule enabled merchant using eligibility V4 API when txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV4")
    @Test(priority = 37, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMinTxnAmtEligibilityV4() throws Exception {
    ...
    @Description("To verify the 2FA enable=False for 2FA and deviceRule enabled merchant using eligibility V4 API for trusted device and txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV4")
    @Test(priority = 38, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForTruestedDeviceEligibilityV4() throws Exception {
    ...
    @Description("To verify the 2FA enable=true for 2FA and deviceRule enabled merchant using eligibility V4 API for trusted device and txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV4")
    @Test(priority = 39, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForUnTruestedDeviceEligibilityV4() throws Exception {
    ...
    @Description("To verify the eligibility failed for new user for 2FA and deviceRule enabled merchant using eligibility V4 API when txnAmount>maxTxnAmount set in fraud")
    @Feature("EligibilityV4")
    @Test(priority = 40, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMaxTxnAmtEligibilityV4NewUser() throws Exception {
    ...
    @Description("To verify the eligibility passed for new user for 2FA and deviceRule enabled merchant using eligibility V4 API when txnAmount<maxTxnAmount set in fraud and untrusted device")
    @Feature("EligibilityV4")
    @Test(priority = 41, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMinTxnAmtEligibilityV4NewUser() throws Exception {
