...
public class EligibilityV3Tests {

    public static String signature;

    public static EligibilityPojo eligibilityPojo;

    @Description("To verify the eligibility of a valid user using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 1,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityForEligibleUserV3() throws Exception {
        ...
        request.put("version", TransactionData.ELIGIBILITY_V3);
    ...
    @Description("To verify the eligibility for user with no mobile in eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 2,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3NoMobile() throws Exception {
    ...
    @Description("To verify the eligibility for user with invalid mobile in eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 3,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3InvalidMobile() throws Exception {
    ...
    @Description("To verify the eligibility for user with invalid mobile format in eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 4,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3ForInvalidMobileFormat() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without email using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 5,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3ForEligibleUserWithoutEmail() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without firstname using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 6,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3ForUserWithoutFirstName() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without last name using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 7,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3ForUserWithoutLastName() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without product details using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 8,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3WithoutProductDetails() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without address details using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 9,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3WithoutAddressDetails() throws Exception {
    ...
    @Description("To verify the eligibility of a  user with invalid amount using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 10,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3WithInvalidAmount() throws Exception {
    ...
    @Description("To verify the eligibility of a  user with invalid currency using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 11,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3WithInvalidCurrency() throws Exception {
    ...
    @Description("To verify the eligibility of a blocked user using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 12,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3UserBlocked() throws Exception {
    ...
    @Description("To verify the eligibility of a fraud blocked using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 13,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3UserFraud() throws Exception {
        ...
        Assert.assertEquals(CheckEligibility.eligibilityPojo.error,"Bad Request", "Failure reason could be different else check if the validation still exist in code");
        Assert.assertEquals(CheckEligibility.eligibilityPojo.message,"Oops!! Your LazyPay account seems to be blocked", "Failure reason could be different else check if the validation still exist in code");
        Assert.assertEquals(CheckEligibility.eligibilityPojo.errorCode,"LP_USER_BLOCKED", "Failure reason could be different else check if the validation still exist in code");
    }

    @Description("To verify the eligibility of locked user using eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 14,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3UserLocked() throws Exception {
    ...
    @Description("To verify the  eligibility V3 API without signature")
    @Feature("EligibilityV3")
    @Test(priority = 15,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3WithoutSignature() throws Exception {
    ...
    @Description("To verify the eligibility V3 for signature mismatch")
    @Feature("EligibilityV3")
    @Test(priority = 16,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3SignatureMismatch() throws Exception {
    ...
    @Description("To verify the eligibility V3 for invalid merchant")
    @Feature("EligibilityV3")
    @Test(priority = 17,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3InvalidMerchant() throws Exception {
    ...
    @Description("To verify the eligibility V3 for maximum transaction limit")
    @Feature("EligibilityV3")
    @Test(priority = 18,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3MaxTxnLimit() throws Exception {
    ...
    @Description("To verify the eligibility V3 for amount > credit limit")
    @Feature("EligibilityV3")
    @Test(priority = 19,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3TxnAmtGTLimit() throws Exception {
    ...
    @Description("To verify the eligibility V3 for txn amount > balance amount")
    @Feature("EligibilityV3")
    @Test(priority = 20,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV3TxnGTBalance() throws Exception {
    ...
    /*@Description("To verify the eligibility V3 for more than 10 custom params")
    @Feature("EligibilityV3")
    @Test(priority = 21,groups = { "eligibility","transaction", "regression"})*/
    public void verifyEligibilityV3CustomParamLimit() throws Exception {
    ...
    @Description("To verify the eligibility V3 for fraud domain, new user")
    @Feature("EligibilityV3")
    @Test(priority = 22,groups = { "eligibility","transaction", "regression"})
    public void verifyFraudDomainV3() throws Exception {
        ...
        Assert.assertEquals(CheckEligibility.eligibilityPojo.error, "Bad Request", "Failure reason could be different else check if the user state has changed");
        Assert.assertEquals(CheckEligibility.eligibilityPojo.message, "Oops!! Something went wrong");
        Assert.assertEquals(CheckEligibility.eligibilityPojo.errorCode,"LP_FD_NEW", "Failure reason could be different else check if the user state has changed");
    }

    /*@Description("To verify the eligibility V3 for more than 10 custom params")
    @Feature("EligibilityV3")
    @Test(priority = 23,groups = { "eligibility","transaction", "regression"})*/
    public void verifyCustomParamKeyLimitV3() throws Exception {
    ...
    @Description("To verify the eligibility V3 without custom params")
    @Feature("EligibilityV3")
    @Test(priority = 24,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3WithoutCustomParams() throws Exception {
    ...
    @Description("To verify the eligibility for non transacted user with valid details in eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 25,groups = { "eligibility","transaction","regression", "sanity"})
    public void verifyEligibilityForEligibleNonTransactedUserV3() throws Exception {
    ...
    @Description("To verify the eligibility for new user with valid details in eligibility V3 API")
    @Feature("EligibilityV3")
    @Test(priority = 26,groups = { "eligibility","transaction","regression", "sanity"})
    public void verifyEligibilityForEligibleNewUserV3() throws Exception {
    ...
    @Description("To verify the eligibility V3 is allowed for an amount less than maximum transaction limit")
    @Feature("EligibilityV3")
    @Test(priority = 27,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3LessThanMaxTxnLimit() throws Exception {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V3 API with source=CITRUS_SDK")
    @Feature("EligibilityV3")
    @Test(priority = 28,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3SourceCitrusSDK() {
    ...
    @Description("To verify the data type in eligibility V3 response when source=CitrusSDK")
    @Feature("EligibilityV3")
    @Test(priority = 29,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3DataTypeValidationSourceCitrusSDK() {
        ...
        Assert.assertEquals(CheckEligibility.eligibilityPojo.requestId.getClass().getSimpleName(), String.class.getSimpleName());
        ...
        Allure.addAttachment(CheckEligibility.eligibilityPojo.requestId.getClass().getSimpleName(), String.class.getSimpleName());
    ...
    @Description("To verify the eligibility of a valid user using eligibility V3 API with source=CITRUS_SSLV3")
    @Feature("EligibilityV3")
    @Test(priority = 30,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3SourceCitrusSSLV3() throws Exception {
    ...
    @Description("To verify the data type in eligibility V3 response when source=CitrusSSLV3")
    @Feature("EligibilityV3")
    @Test(priority = 31,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3DataTypeValidationSourceCitrusSSLV3() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V3 API with source=STANDALONE_API")
    @Feature("EligibilityV3")
    @Test(priority = 32,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3SourceStandaloneAPI() throws Exception {
    ...
    @Description("To verify the data type in eligibility V3 response when source=STANDALONE_API")
    @Feature("EligibilityV3")
    @Test(priority = 33,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3DataTypeValidationSourceStandaloneAPI() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V3 API with source=STANDALONE_REDIRECT")
    @Feature("EligibilityV3")
    @Test(priority = 34,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3SourceCitrusStandaloneRedirect() throws Exception {
    ...
    @Description("To verify the data type in eligibility V3 response when source=STANDALONE_REDIRECT")
    @Feature("EligibilityV3")
    @Test(priority = 35,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV3DataTypeValidationSourceStandaloneRedirect() {
    ...
    @Description("To verify the 2FA enable=true for 2FA and deviceRule enabled merchant using eligibility V3 API when txnAmount>maxTxnAmount set in fraud")
    @Feature("EligibilityV3")
    @Test(priority = 36, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMaxTxnAmtEligibilityV3() throws Exception {
    ...
    @Description("To verify the 2FA enable=false for 2FA and deviceRule enabled merchant using eligibility V3 API when txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV3")
    @Test(priority = 37, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMinTxnAmtEligibilityV3() throws Exception {
    ...
    @Description("To verify the 2FA enable=False for 2FA and deviceRule enabled merchant using eligibility V3 API for trusted device and txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV3")
    @Test(priority = 38, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForTruestedDeviceEligibilityV3() throws Exception {
    ...
    @Description("To verify the 2FA enable=true for 2FA and deviceRule enabled merchant using eligibility V3 API for trusted device and txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV3")
    @Test(priority = 39, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForUnTruestedDeviceEligibilityV3() throws Exception {
    ...
    @Description("To verify the eligibility failed for new user for 2FA and deviceRule enabled merchant using eligibility V3 API when txnAmount>maxTxnAmount set in fraud")
    @Feature("EligibilityV3")
    @Test(priority = 40, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMaxTxnAmtEligibilityV3NewUser() throws Exception {
    ...
    @Description("To verify the eligibility passed for new user for 2FA and deviceRule enabled merchant using eligibility V3 API when txnAmount<maxTxnAmount set in fraud and untrusted device")
    @Feature("EligibilityV3")
    @Test(priority = 41, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMinTxnAmtEligibilityV3NewUser() throws Exception {
