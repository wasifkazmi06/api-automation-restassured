...
public class PayV4WithOTPTests {

    static Map<String, Object> mapOTP;

    @Description("To verify pay v4 for a valid user with source as CITRUS_SDK")
    @Feature("PayWithOTPV4")
    @Test(priority = 1, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV4V0LPSourceCitrusSDK() throws Exception {
        ...
        request.put("payVersion", TransactionData.PAY_V4);
    ...
    @Description("To data types of pay v4 response when source is CITRUS_SDK")
    @Feature("PayWithOTPV4")
    @Test(priority = 2, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV4DataTypeSourceCitrusSDK() {
    ...
    @Description("To verify pay v4 for a valid user with source as CITRUS_SSLV2")
    @Feature("PayWithOTPV4")
    @Test(priority = 3, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV4V0SourceCitrusSSLV5() throws Exception {
    ...
    @Description("To data types of pay v4 response when source is CITRUS_SSLV2")
    @Feature("PayWithOTPV4")
    @Test(priority = 4, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV4DataTypeSourceCitrusSSLV5() {
    ...
    @Description("To verify pay v4 for a valid user with source as STANDALONE_API")
    @Feature("PayWithOTPV4")
    @Test(priority = 5, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV4V0SourceStandaloneAPI() throws Exception {
    ...
    @Description("To data types of pay v4 response when source is STANDALONE_API")
    @Feature("PayWithOTPV4")
    @Test(priority = 6, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV4DataTypeSourceStandaloneAPI() {
    ...
    @Description("To verify pay v4 for a valid user with source as STANDALONE_REDIRECT")
    @Feature("PayWithOTPV4")
    @Test(priority = 7, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV4V0SourceStandaloneRedirect() throws Exception {
    ...
    @Description("To data types of pay v4 response when source is STANDALONE_REDIRECT")
    @Feature("PayWithOTPV4")
    @Test(priority = 8, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV4DataTypeSourceStandaloneRedirect() {
    ...
    @Description("To verify pay v4 for a valid user")
    @Feature("PayWithOTPV4")
    @Test(priority = 9, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayV4V1LP() throws Exception {
    ...
    public void PayV4V2LP() throws Exception {
    ...
    public void PayV4V4LP() throws Exception {
    ...
    @Description("To verify pay v4 for a valid user with blank txn ref no.")
    @Feature("PayWithOTPV4")
    @Test(priority = 12, groups = {"pay", "transaction", "regression"})
    public void PayV4V4BlankTxnLP() throws Exception {
    ...
    @Description("To verify pay v4 for a valid user with invalid txn ref no.")
    @Feature("PayWithOTPV4")
    @Test(priority = 13, groups = {"pay", "transaction", "regression"})
    public void PayV4V4InvalidTxnLP() throws Exception {
    ...
    @Description("To verify pay v4 for a valid user with blank OTP")
    @Feature("PayWithOTPV4")
    @Test(priority = 14, groups = {"pay", "transaction", "regression"})
    public void PayV4V4BlankOtpLP() throws Exception {
    ...
    @Description("To verify pay v4 for a valid user with invalid OTP")
    @Feature("PayWithOTPV4")
    @Test(priority = 15, groups = {"pay", "transaction", "regression"})
    public void PayV4V4InvalidOtpLP() throws Exception {
    ...
    @Description("To verify pay v4 for a valid user with 3 incorrect OTP")
    @Feature("PayWithOTPV4")
    @Test(priority = 16, groups = {"pay", "transaction", "regression"})
    public void payV4V0With3IncorrectOtpLP() throws Exception {
    ...
    public void PayV4V4SignatureRequiredLP() throws Exception {
