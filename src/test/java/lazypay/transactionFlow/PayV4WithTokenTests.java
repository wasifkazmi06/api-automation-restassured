...
import api.lazypay.transaction.PayV4;
...
public class PayV4WithTokenTests {

    public PayV4WithTokenTests() throws Exception {
    ...
    PayV4 payV4 = new PayV4();

    @Description("To verify pay v0 for a valid user")
    @Feature("PayWithTokenV4")
    @Test(priority = 1, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayWithTokenV4LP() throws Exception {

        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();

        authToken = "Bearer "+ generateToken.generateToken(TransactionData.ACCESS_KEY, TransactionData.USER_MOBILE_VALID7, TransactionData.USER_EMAIL,"","");
        ...
        String PayRequest = new StringTemplate(LazypayConstants.PAY_WITH_TOKEN)
                ...
                .replace("mobile", TransactionData.USER_MOBILE_VALID7)
        ...
        PayPojo payPojo = payV4.post(queryParamDetails, headerDetails, PayRequest);
    ...
    @Description("To verify pay with token v4 for a valid user having invalid token")
    @Feature("PayWithTokenV4")
    @Test(priority = 2, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayWithTokenV4LP_InvalidTokenLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    @Description("To verify pay with token v4 for a valid user having expired token")
    @Feature("PayWithTokenV4")
    @Test(priority = 3, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_ExpiredTokenLP() throws Exception {
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    @Description("To verify pay with token v4 for a valid user with duplicate txn")
    @Feature("PayWithTokenV4")
    @Test(priority = 4, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_DuplicateTxnLP() throws Exception {
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    public void PayWithTokenV4LP_BlankMobile() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    public void PayWithTokenV4LP_InvalidMobile() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    public void PayWithTokenV4LP_WithoutMail() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    public void PayWithTokenV4LP_WithoutFirstName() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();

        authToken_EmailRequired = "Bearer "+ generateToken.generateToken(TransactionData.ACCESS_KEY_EMAIL_REQUIRED, TransactionData.USER_MOBILE_VALID7, TransactionData.USER_EMAIL,TransactionData.FIRST_NAME,TransactionData.LAST_NAME);
    ...
    public void PayWithTokenV4LP_WithoutLastName() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
    ...
    @Description("To verify pay with token v4 for a blocked user")
    @Feature("PayWithTokenV4")
    @Test(priority = 10, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_BlockedUserLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
...
//        authToken = "Bearer "+ generateToken.generateToken(TransactionData.ACCESS_KEY, TransactionData.USER_MOBILE_VALID7, TransactionData.USER_EMAIL,"","");
        signature = GenerateSignature.generateSignature("merchantAccessKey="+TransactionData.ACCESS_KEY+"&transactionId="+MTX
                +"&amount="+TransactionData.TRANSACTION_AMOUNT, TransactionData.ACCESS_KEY);
        TransactionData.updateRestriction(TransactionData.USER_MOBILE_VALID7, "blocked");
        ...
        PayPojo payPojo = payV4.post(queryParamDetails, headerDetails, PayRequest);
        TransactionData.updateRestriction(TransactionData.USER_MOBILE_VALID7, "null");
    ...
    @Description("To verify pay with token v4 for a locked user")
    @Feature("PayWithTokenV4")
    @Test(priority = 11, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayWithTokenV4LP_LockedUserLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        ...
        TransactionData.updateRestriction(TransactionData.USER_MOBILE_VALID7, "locked");
    ...
    @Description("To verify pay with token v4 for a fraud user")
    @Feature("PayWithTokenV4")
    @Test(priority = 12, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayWithTokenV4LP_BlackListedUserLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");

        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();

//        authToken = "Bearer "+ generateToken.generateToken(TransactionData.ACCESS_KEY, TransactionData.USER_MOBILE_VALID7, "","","");
        signature = GenerateSignature.generateSignature("merchantAccessKey="+TransactionData.ACCESS_KEY+"&transactionId="+MTX
                +"&amount="+TransactionData.TRANSACTION_AMOUNT, TransactionData.ACCESS_KEY);

        TransactionData.updateRestriction(TransactionData.USER_MOBILE_VALID7, "blacklisted");
    ...
    @Description("To verify pay with token v4 for a opted out user")
    @Feature("PayWithTokenV4")
    @Test(priority = 13, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_OptedOutUserLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");

        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
//        DeleteUser.deleteUserByMobile(TransactionData.USER_MOBILE_VALID7, "lp");

        signature = GenerateSignature.generateSignature("merchantAccessKey="+TransactionData.ACCESS_KEY+"&transactionId="+MTX
                +"&amount="+TransactionData.TRANSACTION_AMOUNT, TransactionData.ACCESS_KEY);
        TransactionData.updateOptedOutUser(TransactionData.USER_MOBILE_VALID7,"1", "OPTED_OUT" );
        ...
        PayPojo payPojo = payV4.post(queryParamDetails, headerDetails, PayRequest);
        TransactionData.updateOptedOutUser(TransactionData.USER_MOBILE_VALID7,"0", "ACTIVE" );
    ...
    @Description("To verify pay with token v4 for a valid user with invalid amount")
    @Feature("PayWithTokenV4")
    @Test(priority = 14, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_InvalidAmount() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
    ...
    @Description("To verify pay with token v4 for a valid user with invalid currency")
    @Feature("PayWithTokenV4")
    @Test(priority = 15, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_InvalidCurrencyLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
    ...
    @Description("To verify pay with token v4 for a valid user with without signature")
    @Feature("PayWithTokenV4")
    @Test(priority = 16, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_WithoutSignatureLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();
...
//        headerDetails.put("signature", "");
    ...
    @Description("To verify pay with token v4 for a valid user with incorrect signature")
    @Feature("PayWithTokenV4")
    @Test(priority = 17, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_IncorrectSignatureLP() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
    ...
    @Description("To verify pay with token v4 for a valid user with more than max txn limit")
    @Feature("PayWithTokenV4")
    @Test(priority = 18, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayWithTokenV4LP_MaxTxnLimit() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
    ...
    @Description("To verify pay with token v4 for a valid user with txn amount more than credit limit")
    @Feature("PayWithTokenV4")
    @Test(priority = 19, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayWithTokenV4LP_MoreThanCreditLimit() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");

        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();

        String authTokenMoreThenLowCredit = "Bearer "+ generateToken.generateToken(TransactionData.ACCESS_KEY, TransactionData.USER_MOBILE_LOW_CREDIT_LIMIT, TransactionData.USER_EMAIL,"","");
        signature = GenerateSignature.generateSignature("merchantAccessKey="+TransactionData.ACCESS_KEY+"&transactionId="+MTX
                +"&amount="+TransactionData.TRANSACTION_AMOUNT_HIGH, TransactionData.ACCESS_KEY);
        headerDetails.put("Authorization", authTokenMoreThenLowCredit);
        headerDetails.put("signature", signature);
    ...
    @Description("To verify pay with token v4 for a valid user with txn amount more than available credit limit")
    @Feature("PayWithTokenV4")
    @Test(priority = 20, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_moreThanAvailableCreditLimit() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");

        Map<String, Object> queryParamDetails = new HashMap<>();
        HashMap<String, String> headerDetails = new HashMap<>();

//        String authToken_USerMobileMaxedOut = "Bearer "+ generateToken.generateToken(TransactionData.ACCESS_KEY, TransactionData.USER_MOBILE_MAXED_OUT, TransactionData.USER_EMAIL,"","");
        signature = GenerateSignature.generateSignature("merchantAccessKey="+TransactionData.ACCESS_KEY+"&transactionId="+MTX
                +"&amount="+TransactionData.TRANSACTION_AMOUNT_HIGH, TransactionData.ACCESS_KEY);
    ...
    @Description("To verify pay with token v4 for a valid user without optional fields")
    @Feature("PayWithTokenV4")
    @Test(priority = 21, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_withoutOptionalFields() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
        ...
        PayPojo payPojo = payV4.post(queryParamDetails, headerDetails, payRequestJson.toString());
    ...
    @Description("To verify pay with token v4 for a valid user without custom params")
    @Feature("PayWithTokenV4")
    @Test(priority = 22, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_withoutCustomParams() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
...
//        payRequestJson.put("customParams", " ");
    ...
    @Description("To verify pay with token v4 for a valid user with more than 30 char custom param key")
    @Feature("PayWithTokenV4")
    @Test(priority = 23, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_customParamKeyLimit() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
    ...
    @Description("To verify pay with token v4 for a valid user")
    @Feature("PayWithTokenV4")
    @Test(priority = 24, groups = {"pay", "transaction", "regression"})
    public void PayWithTokenV4LP_moreThan10CustomParams() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
    ...
    public void PayWithTokenV4LP_LessThanMaxTxnLimit() throws Exception {
        MTX = ReturnRandomTxnId.returnTxnIDMethod("MTX");
