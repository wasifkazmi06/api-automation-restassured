...
import api.lazypay.transaction.InitiateV2;
...
public class InitiatePayV2Tests {

    public InitiatePayV2Tests() {
    }
    ...
    @Description("Verify that valid user is able to initiate a BNPL transaction using the v2 version of initiate pay with source = CITRUS_SDK")
    @Feature("InitiatePayV2")
    @Test(priority = 1, groups = {"transaction", "regression", "sanity"})
    public static void initiateV2LPSourceCitrusSDK() throws Exception {
        ...
        request.put("initiateVersion", TransactionData.INITIATE_PAY_V2);
    ...
    @Description("To data types of initiate v2 response when source is CITRUS_SDK")
    @Feature("InitiatePayV2")
    @Test(priority = 2, groups = {"transaction", "regression", "sanity"})
    public void initiatev2DataTypeSourceCitrusSDK() {
    ...
    @Description("Verify that valid user is able to initiate a BNPL transaction using the v2 version of initiate pay with source = CITRUS_SSLV2")
    @Feature("InitiatePayV2")
    @Test(priority = 3, groups = {"transaction", "regression", "sanity"})
    public static void initiateV2LPSourceCitrusSSLV2() throws Exception {
    ...
    @Description("To data types of initiate v2 response when source is CITRUS_SSLV2")
    @Feature("InitiatePayV2")
    @Test(priority = 4, groups = {"transaction", "regression", "sanity"})
    public void initiatev2DataTypeSourceCitrusSSLV2() {
    ...
    @Description("Verify that valid user is able to initiate a BNPL transaction using the v2 version of initiate pay with source = STANDALONE_API")
    @Feature("InitiatePayV2")
    @Test(priority = 5, groups = {"transaction", "regression", "sanity"})
    public static void initiateV2LPSourceStandaloneAPI() throws Exception {
    ...
    @Description("To data types of initiate v2 response when source is STANDALONE_API")
    @Feature("InitiatePayV2")
    @Test(priority = 6, groups = {"transaction", "regression", "sanity"})
    public void initiatev2DataTypeSourceStandaloneAPI() {
    ...
    public static void initiateV2LPSourceStandaloneAPIRedirectFlow() throws Exception {
    ...
    public void initiatev2DataTypeSourceStandaloneAPIRedirectFlow() {
    ...
    @Description("Verify that valid user is able to initiate a BNPL transaction using the v2 version of initiate pay with source = STANDALONE_REDIRECT")
    @Feature("InitiatePayV2")
    @Test(priority = 9, groups = {"transaction", "regression", "sanity"})
    public static void initiateV2LPSourceStandaloneRedirect() throws Exception {
    ...
    @Description("To data types of initiate v2 response when source is STANDALONE_REDIRECT")
    @Feature("InitiatePayV2")
    @Test(priority = 10, groups = {"transaction", "regression", "sanity"})
    public void initiatev2DataTypeSourceStandaloneRedirect() {
    ...
    public static void initiateV2LPSourceStandaloneRedirectRedirectFlow() throws Exception {
    ...
    public void initiatev2DataTypeSourceStandaloneRedirectRedirectFlow() {
    ...
    @Description("Verify a valid user is able to initiate a BNPL transaction without passing the user's email address for merchant not requiring email address using the v2 version of initiate pay")
    @Feature("InitiatePayV2")
    @Test(priority = 13, groups = { "transaction", "regression", "sanity"})
    public void initiateV2LPWithoutEmail() throws Exception {
    ...
    @Description("Verify that a blocked user should not be able to initiate a BNPL transaction using initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 14, groups = { "transaction", "regression"})
    public void initiateV2LPBlockedUser() throws Exception {
        ...
        Assert.assertEquals(MakeTransaction.initiatePojo.path,"/api/lazypay/v2/payment/initiate");
    }

    @Description("Verify that an locked user should not be able to initiate a BNPL transaction using initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 15, groups = { "transaction", "regression"})
    public void initiateV2LPLockedUser() throws Exception {
    ...
    @Description("Verify that a fraud user should not be able to initiate a BNPL transaction using initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 16, groups = { "transaction", "regression"})
    public void initiateV2LPBlackListedUser() throws Exception {
    ...
    @Description("Verify that an error is thrown if a transaction is initiate of amount greater than user's credit limit using the initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 17, groups = { "transaction", "regression", "sanity"})
    public void initiateV2LPForTxnAmtGreaterThanLimit() throws Exception {
    ...
    @Description("Verify that an error is thrown if a transaction is initiate of amount greater than user's available credit limit using the initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 18, groups = { "transaction", "regression"})
    public void initiateV2LP_moreThanAvailableCreditLimit() throws Exception {
    ...
    @Description("Verify that an error is thrown if a transaction equal to or greater than 9999 is initiated using initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 19, groups = { "transaction", "regression", "sanity"})
    public void initiateV2LPMaxTxnLimit() throws Exception {
    ...
    @Description("Verify that valid user is able to initiate a BNPL transaction using the v2 version of initiate pay")
    @Feature("InitiatePayV2")
    @Test(priority = 20, groups = { "transaction", "regression"})
    public void initiateV2LPDuplicateMTX() throws Exception {
    ...
    @Description("Verify that an error is thrown if a BNPL transaction is initiated for an invalid merchant using initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 21, groups = { "transaction", "regression"})
    public void initiateV2LPForInvalidMerchant() throws Exception {
    ...
    @Description("Verify a user should not be able to initiate a transaction when source is SOURCE_CITRUS_SSLV2 and CTX is not passed in the initiate v2 API request")
    @Feature("InitiatePayV2")
    @Test(priority = 22, groups = { "transaction", "regression"})
    public void initiateV2LPMandatoryCTXErrorSourceCitrusSSLV2() throws Exception {
    ...
    @Description("Verify a user should not be able to initiate a transaction merchant access key is not passed in the initiate v2 API request")
    @Feature("InitiatePayV2")
    @Test(priority = 23, groups = { "transaction", "regression"})
    public void initiateV2LPMandatoryMerchantAccessKeyError() throws Exception {
    ...
    @Description("Verify a user should not be able to initiate a transaction of zero amount using initiate v2 API request")
    @Feature("InitiatePayV2")
    @Test(priority = 24, groups = { "transaction", "regression", "sanity"})
    public void initiateV2LPZeroAmountError() throws Exception {
    ...
    @Description("Verify a user with fraud email address domain should not be able to initiate a transaction using initiate v2 API request")
    @Feature("InitiatePayV2")
    @Test(priority = 25, groups = { "transaction", "regression"})
    public void initiateV2LPFraudDomainError() throws Exception {
    ...
    @Description("Verify that for a merchant requiring user's email an error should be thrown if email is not passed in the initiate v2 request")
    @Feature("InitiatePayV2")
    @Test(priority = 26, groups = { "transaction", "regression"})
    public void initiateV2LPWithoutEmailError() throws Exception {
    ...
    @Description("Verify that an error is thrown if an incorrect amount is passed in the initiate v2 request")
    @Feature("InitiatePayV2")
    @Test(priority = 27, groups = {"transaction", "regression"})
    public void initiateV2LPInvalidAmount() throws Exception {
    ...
    @Description("Verify that an error is thrown if signature is not passed in the initiate v2 request header")
    @Feature("InitiatePayV2")
    @Test(priority = 28, groups = { "transaction", "regression"})
    public void initiateV2LPWithoutSignature() throws Exception {
    ...
    @Description("Verify that an error is thrown if an incorrect signature is passed in the initiate v2 request header")
    @Feature("InitiatePayV2")
    @Test(priority = 29, groups = {"transaction", "regression"})
    public void initiateV2LPInvalidSignature() throws Exception {
    ...
    @Description("Verify mandatory validation on mobile number for the initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 30, groups = { "transaction", "regression"})
    public void initiateV2LPMandatoryMobileError() throws Exception {
    ...
    @Description("Verify the validation that mobile number should be equal to 10 digits on the initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 31, groups = { "transaction", "regression"})
    public void initiateV2LPMobileNotEqual10Digit() throws Exception {
    ...
    @Description("Verify the validation that mobile number should only be integers on initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 32, groups = { "transaction", "regression"})
    public void initiateV2LPMobileOnlyIntegers() throws Exception {
    ...
    @Description("Verify that for a merchant requiring user's first name an error should be thrown if first name is not passed in the initiate v2 request")
    @Feature("InitiatePayV2")
    @Test(priority = 33, groups = { "transaction", "regression"})
    public void initiateV2LPWithoutFirstName() throws Exception {
    ...
    @Description("Verify that for a merchant requiring user's last name an error should be thrown if last name is not passed in the initiate v2 request")
    @Feature("InitiatePayV2")
    @Test(priority = 34, groups = { "transaction", "regression"})
    public void initiateV2LPWithoutLastName() throws Exception {
    ...
    @Description("Verify that for a merchant requiring user's first and last name a BNPL transaction should be initiated when both the parameters are passed in the initiate v2 request")
    @Feature("InitiatePayV2")
    @Test(priority = 35, groups = { "transaction", "regression"})
    public void initiateV2LPWithFirstLastName() throws Exception {
    ...
    @Description("Verify that an error is not thrown if a transaction less than max transaction limit is initiated using initiate v2 API")
    @Feature("InitiatePayV2")
    @Test(priority = 36, groups = {"transaction", "regression", "sanity"})
    public void initiateV2LPLessThanMaxTxnLimit() throws Exception {
