...
import api.lazypay.transaction.EligibilityV1;
...
public class EligibilityV1Tests {

    public static String signature;

    public static EligibilityPojo eligibilityPojo;

    @Description("To verify the eligibility of a valid user using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 1,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityForEligibleUserV1() throws Exception {
        ...
        request.put("version", TransactionData.ELIGIBILITY_V1);
    ...
    @Description("To verify the eligibility for user with no mobile in eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 2,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1NoMobile() throws Exception {
    ...
    @Description("To verify the eligibility for user with invalid mobile in eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 3,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1InvalidMobile() throws Exception {
    ...
    @Description("To verify the eligibility for user with invalid mobile format in eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 4,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1ForInvalidMobileFormat() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without email using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 5,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1ForEligibleUserWithoutEmail() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without firstname using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 6,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1ForUserWithoutFirstName() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without last name using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 7,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1ForUserWithoutLastName() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without product details using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 8,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1WithoutProductDetails() throws Exception {
    ...
    @Description("To verify the eligibility of a  user without address details using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 9,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1WithoutAddressDetails() throws Exception {
    ...
    @Description("To verify the eligibility of a  user with invalid amount using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 10,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1WithInvalidAmount() throws Exception {
    ...
    @Description("To verify the eligibility of a  user with invalid currency using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 11,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1WithInvalidCurrency() throws Exception {
    ...
    @Description("To verify the eligibility of a blocked user using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 12,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1UserBlocked() throws Exception {
    ...
    @Description("To verify the eligibility of a fraud blocked using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 13,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1UserFraud() throws Exception {
    ...
    @Description("To verify the eligibility of locked user using eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 14,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1UserLocked() throws Exception {
    ...
    @Description("To verify the  eligibility V1 API without signature")
    @Feature("EligibilityV1")
    @Test(priority = 15,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1WithoutSignature() throws Exception {
    ...
    @Description("To verify the eligibility V1 for signature mismatch")
    @Feature("EligibilityV1")
    @Test(priority = 16,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1SignatureMismatch() throws Exception {
    ...
    @Description("To verify the eligibility V1 for invalid merchant")
    @Feature("EligibilityV1")
    @Test(priority = 17,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1InvalidMerchant() throws Exception {
    ...
    @Description("To verify the eligibility V1 for maximum transaction limit")
    @Feature("EligibilityV1")
    @Test(priority = 18,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1MaxTxnLimit() throws Exception {
    ...
    @Description("To verify the eligibility V1 for amount > credit limit")
    @Feature("EligibilityV1")
    @Test(priority = 19,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1TxnAmtGTLimit() throws Exception {
    ...
    @Description("To verify the eligibility V1 for txn amount > balance amount")
    @Feature("EligibilityV1")
    @Test(priority = 20,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1TxnGTBalance() throws Exception {
    ...
    @Description("To verify the eligibility V1 for more than 10 custom params")
    @Feature("EligibilityV1")
    @Test(priority = 21,groups = { "eligibility","transaction", "regression"})
    public void verifyEligibilityV1CustomParamLimit() throws Exception {
    ...
    @Description("To verify the eligibility V1 for fraud domain, new user")
    @Feature("EligibilityV1")
    @Test(priority = 22,groups = { "eligibility","transaction", "regression"})
    public void verifyFraudDomainV1() throws Exception {
    ...
    public void verifyCustomParamKeyLimitV1() throws Exception {
    ...
    @Description("To verify the eligibility V1 without custom params")
    @Feature("EligibilityV1")
    @Test(priority = 24,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1WithoutCustomParams() throws Exception {
    ...
    @Description("To verify the eligibility for non transacted user with valid details in eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 25,groups = { "eligibility","transaction","regression"})
    public void verifyEligibilityForEligibleNonTransactedUserV1() throws Exception {
    ...
    @Description("To verify the eligibility for new user with valid details in eligibility V1 API")
    @Feature("EligibilityV1")
    @Test(priority = 26,groups = { "eligibility","transaction","regression"})
    public void verifyEligibilityForEligibleNewUserV1() throws Exception {
    ...
    @Description("To verify the eligibility V1 is allowed for an amount less than maximum transaction limit")
    @Feature("EligibilityV1")
    @Test(priority = 27,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1LessThanMaxTxnLimit() throws Exception {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V1 API with source=CITRUS_SDK")
    @Feature("EligibilityV1")
    @Test(priority = 28,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1SourceCitrusSDK() {
    ...
    @Description("To verify the data type in eligibility V1 response when source=CitrusSDK")
    @Feature("EligibilityV1")
    @Test(priority = 29,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1DataTypeValidationSourceCitrusSDK() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V1 API with source=CITRUS_SSLV2")
    @Feature("EligibilityV1")
    @Test(priority = 30,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1SourceCitrusSSLV2() throws Exception {
    ...
    @Description("To verify the data type in eligibility V1 response when source=CitrusSSLV2")
    @Feature("EligibilityV1")
    @Test(priority = 31,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1DataTypeValidationSourceCitrusSSLV2() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V1 API with source=STANDALONE_API")
    @Feature("EligibilityV1")
    @Test(priority = 32,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1SourceStandaloneAPI() throws Exception {
    ...
    @Description("To verify the data type in eligibility V1 response when source=STANDALONE_API")
    @Feature("EligibilityV1")
    @Test(priority = 33,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1DataTypeValidationSourceStandaloneAPI() {
    ...
    @Description("To verify the eligibility of a valid user using eligibility V1 API with source=STANDALONE_REDIRECT")
    @Feature("EligibilityV1")
    @Test(priority = 34,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1SourceCitrusStandaloneRedirect() throws Exception {
    ...
    @Description("To verify the data type in eligibility V1 response when source=STANDALONE_REDIRECT")
    @Feature("EligibilityV1")
    @Test(priority = 35,groups = { "eligibility","transaction", "regression", "sanity"})
    public void verifyEligibilityV1DataTypeValidationSourceStandaloneRedirect() {
    ...
    @Description("To verify the 2FA enable=true for 2FA and deviceRule enabled merchant using eligibility V1 API when txnAmount>maxTxnAmount set in fraud")
    @Feature("EligibilityV1")
    @Test(priority = 36, groups = {"eligibility", "2FA", "transaction", "regression", "sanity"})
    public void verify2FAFlagValueWith2FAAndDeviceForMaxTxnAmtEligibilityV1() throws Exception {
    ...
    @Description("To verify the 2FA enable=false for 2FA and deviceRule enabled merchant using eligibility V1 API when txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV1")
    @Test(priority = 37, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMinTxnAmtEligibilityV1() throws Exception {
    ...
    @Description("To verify the 2FA enable=False for 2FA and deviceRule enabled merchant using eligibility V1 API for trusted device and txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV1")
    @Test(priority = 38, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForTruestedDeviceEligibilityV1() throws Exception {
    ...
    @Description("To verify the 2FA enable=true for 2FA and deviceRule enabled merchant using eligibility V1 API for trusted device and txnAmount<maxTxnAmount set in fraud")
    @Feature("EligibilityV1")
    @Test(priority = 39, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForUnTruestedDeviceEligibilityV1() throws Exception {
    ...
    @Description("To verify the eligibility failed for new user for 2FA and deviceRule enabled merchant using eligibility V1 API when txnAmount>maxTxnAmount set in fraud")
    @Feature("EligibilityV1")
    @Test(priority = 40, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMaxTxnAmtEligibilityV1NewUser() throws Exception {
    ...
    @Description("To verify the eligibility passed for new user for 2FA and deviceRule enabled merchant using eligibility V1 API when txnAmount<maxTxnAmount set in fraud and untrusted device")
    @Feature("EligibilityV1")
    @Test(priority = 41, groups = {"eligibility", "transaction", "regression", "sanity", "2FA"})
    public void verify2FAFlagValueWith2FAAndDeviceForMinTxnAmtEligibilityV1NewUser() throws Exception {
