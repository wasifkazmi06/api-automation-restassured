...
public class PayV0WithOTPTests {

    public static String signature;
    static public String otp;
    static Map<String, Object> mapOTP;

    @Description("To verify pay v0 for a valid user with source as CITRUS_SDK")
    @Feature("PayWithOTPV0")
    @Test(priority = 1, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV0V0LPSourceCitrusSDK() throws Exception {
        ...
        Assert.assertEquals(MakeTransaction.payPojo.userDetails.get("mobile"), TransactionData.USER_MOBILE_VALID1);
    }

    @Description("To data types of pay v0 response when source is CITRUS_SDK")
    @Feature("PayWithOTPV0")
    @Test(priority = 2, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV0DataTypeSourceCitrusSDK() {
    ...
    @Description("To verify pay v0 for a valid user with source as CITRUS_SSLV2")
    @Feature("PayWithOTPV0")
    @Test(priority = 3, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV0V0SourceCitrusSSLV2() throws Exception {
    ...
    @Description("To data types of pay v0 response when source is CITRUS_SSLV2")
    @Feature("PayWithOTPV0")
    @Test(priority = 4, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV0DataTypeSourceCitrusSSLV2() {
    ...
    @Description("To verify pay v0 for a valid user with source as STANDALONE_API")
    @Feature("PayWithOTPV0")
    @Test(priority = 5, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV0V0SourceStandaloneAPI() throws Exception {
    ...
    @Description("To data types of pay v0 response when source is STANDALONE_API")
    @Feature("PayWithOTPV0")
    @Test(priority = 6, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV0DataTypeSourceStandaloneAPI() {
    ...
    @Description("To verify pay v0 for a valid user with source as STANDALONE_REDIRECT")
    @Feature("PayWithOTPV0")
    @Test(priority = 7, groups = {"pay", "transaction", "regression", "sanity"})
    public static void payV0V0SourceStandaloneRedirect() throws Exception {
    ...
    @Description("To data types of pay v0 response when source is STANDALONE_REDIRECT")
    @Feature("PayWithOTPV0")
    @Test(priority = 8, groups = {"pay", "transaction", "regression", "sanity"})
    public void payV0DataTypeSourceStandaloneRedirect() {
    ...
    public void payV0V1LP() throws Exception {
        ...
        Assert.assertNotNull(MakeTransaction.payPojo.token.get("refresh_token"));
        Assert.assertNotNull(MakeTransaction.payPojo.token.get("expires_in"));
        Assert.assertEquals(MakeTransaction.payPojo.userDetails.get("mobile"), TransactionData.USER_MOBILE_VALID2);
    }

    @Description("To verify pay v0 for a valid user")
    @Feature("PayWithOTPV0")
    @Test(priority = 10, groups = {"pay", "transaction", "regression"})
    public void payV0V2LP() throws Exception {
    ...
    public void payV0V4LP() throws Exception {
        ...
        Assert.assertNotNull(MakeTransaction.payPojo.token.get("refresh_token"));
        Assert.assertNotNull(MakeTransaction.payPojo.token.get("expires_in"));
        Assert.assertEquals(MakeTransaction.payPojo.userDetails.get("mobile"), TransactionData.USER_MOBILE_VALID4);
    }

    @Description("To verify pay v0 for a valid user with blank txn ref no.")
    @Feature("PayWithOTPV0")
    @Test(priority = 12, groups = {"pay", "transaction", "regression"})
    public void PayV0V0BlankTxnLP() throws Exception {
    ...
    @Description("To verify pay v0 for a valid user with invalid txn ref no.")
    @Feature("PayWithOTPV0")
    @Test(priority = 13, groups = {"pay", "transaction", "regression"})
    public void PayV0V0InvalidTxnLP() throws Exception {
    ...
    @Description("To verify pay v0 for a valid user with blank OTP")
    @Feature("PayWithOTPV0")
    @Test(priority = 14, groups = {"pay", "transaction", "regression"})
    public void PayV0V0BlankOtpLP() throws Exception {
    ...
    @Description("To verify pay v0 for a valid user with invalid OTP")
    @Feature("PayWithOTPV0")
    @Test(priority = 15, groups = {"pay", "transaction", "regression", "sanity"})
    public void PayV0V0InvalidOtpLP() throws Exception {
    ...
    @Description("To verify pay v0 for a valid user with 3 incorrect OTP")
    @Feature("PayWithOTPV0")
    @Test(priority = 16, groups = {"pay", "transaction", "regression"})
    public void PayV0V0With3IncorrectOtpLP() throws Exception {
    ...
    @Description("To verify pay v0 for a valid user with custom params")
    @Feature("PayWithOTPV0")
    @Test(priority = 17, groups = {"pay", "transaction", "regression"})
    public void PayV0V0SignatureRequiredLP() throws Exception {
