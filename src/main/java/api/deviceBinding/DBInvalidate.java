...
public class DBInvalidate extends BaseAPI<bbpsInitiateOtpResponse> {
    public DBInvalidate() throws Exception {
        super(Uri.DB_INVALIDATE, bbpsInitiateOtpResponse.class);
    }
    @Step
