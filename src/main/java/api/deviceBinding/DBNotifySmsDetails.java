...
public class DBNotifySmsDetails extends BaseAPI<bbpsInitiateOtpResponse> {
    public DBNotifySmsDetails() throws Exception {
        super(Uri.DB_NOTIFY_SMS_DETAILS, bbpsInitiateOtpResponse.class);
    }
    @Step
