...
public class WebhookModifyLien extends BaseAPI<FdDetails> {

    public WebhookModifyLien() throws Exception {
        super(Uri.SECUREDCARD_WEBHOOK_MODIFY_LIEN, FdDetails.class);
    }
    @Step
