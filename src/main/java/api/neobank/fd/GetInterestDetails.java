...
public class GetInterestDetails extends BaseAPI<FdDetails> {

    public GetInterestDetails() throws Exception {
        super(Uri.SECUREDCARD_FD_INTERESTDETAILS, FdDetails.class);
    }
