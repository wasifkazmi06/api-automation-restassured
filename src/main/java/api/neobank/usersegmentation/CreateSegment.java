...
public class CreateSegment extends BaseAPI<User_Segmentation_Pojo> {

    public CreateSegment() throws Exception {
        super(Uri.US_CREATE_SEGMENT, User_Segmentation_Pojo.class);
    }
