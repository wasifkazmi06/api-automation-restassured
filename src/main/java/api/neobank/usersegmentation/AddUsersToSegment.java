...
public class AddUsersToSegment extends BaseAPI<User_Segmentation_Pojo> {

    public AddUsersToSegment() throws Exception {
        super(Uri.US_ADD_USERS, User_Segmentation_Pojo.class);
    }
