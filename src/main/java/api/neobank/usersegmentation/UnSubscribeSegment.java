...
public class UnSubscribeSegment extends BaseAPI<User_Segmentation_Pojo> {


    public UnSubscribeSegment() throws Exception {
        super(Uri.US_UNSUBSCRIBE, User_Segmentation_Pojo.class);
    }
