...
public class SignMITC extends BaseAPI<BifrostResolveStepsResponsePojo> {
    public SignMITC() throws Exception {
        super(Uri.PLATFORM_SIGN_MITC, BifrostResolveStepsResponsePojo.class);
    }
